...
frac12 cordic_tab[3][16] = {
  { 65535, 8999, 4184, 2058, 1025, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1, 0 }, /* HYPERBOLIC */  // 65535 NOT USED
...
void calcTable(uint16_t mode) {
  for (uint16_t i = 0; i < 16; i++) {
    real r = pow(2, -i);
    real a = (mode == HYPERBOLIC) ? atanh(r) : (mode == CIRCULAR) ? atan(r) : r;
    frac12 f = toFrac12(a);
    printf("a(%f) = %f =>  %f  %d\n", r, a, fromFrac12(f), f);
  }
}
